...
if ( $_SESSION[ 'id' ] ) {
	...
	if(isset($_REQUEST['rolesubmit'])){
		...
		$query000="insert into cm_level(level_num,wishlist_n,wishlist_2,wishlist_3,wishlist_no)
	...
	header('Location: configuration.php');
		...
		$wishlist_3 = $_REQUEST['wishlist_3'];
		$not_wishlist = $_REQUEST['not_wishlist'];
		$query000="update cm_level SET level_num='$level',wishlist_n='$wishlist_n',wishlist_2='$wishlist_2',wishlist_3='$wishlist_3',wishlist_no='$not_wishlist' WHERE cl_id =$cl_id";
		mysqli_query($conn,$query000);
		$errmsg_arr[] = '<div class="alert alert-danger alert-dismissable"> <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a> <strong>Success!</strong> Data Add Sucessfully.</div>';
	$errflag = true;
	$_SESSION['register_success'] = $errmsg_arr;
  ...
  <table id="multi_col_order" width="1000">
     ...
     <tbody>
                   ...
                   <tr>
							...
							$id_to_encrypt1 = $row2['cl_id'];
$key = "16_byte_secret_key"; // AES requires a 16-byte key
$encrypted_id = encrypt_id($id_to_encrypt1, $key);
$edit_url = "configuration_form.php?edit=" . urlencode($encrypted_id);
$delete_url = "configuration.php?del=" . urlencode($encrypted_id);
                        ?>

              ...
              <div class="row">
                ...
                <div class="col-12">
                  ...
                  <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                      <form action="bulk_import_forcast.php?status=<?php echo $ses;?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
							<div class="col-md-8 RetRock">
								...
								<select name="event_id" class="form-control" required>
									...
									<?php
									$sql_qrevent = mysqli_query( $conn, "select * from cmf_event WHERE STATUS='Completed'" );
